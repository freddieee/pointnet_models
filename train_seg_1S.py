...
from pointnet6DV1Single import PointNetDenseCls
...
parser.add_argument('--outf', type=str, default='./seg/V1S/',  help='output folder')
...
for epoch in range(opt.nepoch):
    for i, data in enumerate(dataloader, 0):
        ...
        if i % 100 == 0:
            ...
            a=('V1_single [%d: %d/%d] %s loss: %f accuracy: %f IOU: %f mIOU %f' %(epoch, i, num_batch, blue('test'), loss.item(), correct.item()/float(opt.batchSize*opt.num_points),iou,miou))
